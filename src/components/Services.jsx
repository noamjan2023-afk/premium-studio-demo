...
const services = [
  { id: '01', title: 'איתור נזילות', desc: 'איתור מדויק בעזרת מצלמה תרמית ללא הרס מיותר.' },
  { id: '02', title: 'פתיחת סתימות', desc: 'שחרור סתימות מורכבות בעזרת ציוד מתקדם וספירלות חשמליות.' },
  { id: '03', title: 'שיפוץ חדרי אמבטיה', desc: 'החלפת צנרת קומפלט וחידוש חדרי רחצה ברמת גימור מושלמת.' },
  { id: '04', title: 'החלפת צנרת', desc: 'התקנת צנרת SP ופקס חדשה ועמידה לשנים ארוכות.' }
];
