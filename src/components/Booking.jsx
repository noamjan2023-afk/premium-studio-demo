      ...
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="flex flex-col items-center justify-center w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
            ...
            {/* WhatsApp */}
            <a href="https://wa.me/972526410042?text=%D7%94%D7%99%D7%99%20%D7%90%D7%9C%D7%9B%D7%A1%2C%20%D7%94%D7%92%D7%A2%D7%AA%D7%99%20%D7%93%D7%A8%D7%9A%20%D7%94%D7%90%D7%AA%D7%A8%20%D7%95%D7%90%D7%A9%D7%9E%D7%97%20%D7%9C%D7%A2%D7%96%D7%A8%D7%94" target="_blank" rel="noopener noreferrer" className="group flex flex-col items-center text-center gap-4 transition-all duration-300 hover:text-[#25D366] bg-white/5 border border-white/10 p-8 rounded-3xl hover:bg-white/10 hover:border-[#25D366]/30 shadow-xl">
        ...
        <div className="mt-24 pt-8 border-t border-white/20 text-center flex flex-col items-center gap-6">
          <div className="bg-white/10 border border-white/20 rounded-xl p-6 max-w-3xl shadow-lg backdrop-blur-md">
            <p className="text-sm md:text-base text-neutral-200 leading-relaxed font-medium">
              <strong className="text-white">* תנאי שימוש ומדיניות פרטיות:</strong> מובהר בזאת כי אין אחריות על סתימות חוזרות. 
              כמו כן, ייגבה תשלום עבור דמי בדיקה וביקור במקרה בו יתברר לאחר הגעה כי קיים כשל מבני בצנרת שלא ניתן לפתרון במסגרת עבודה רגילה. 
              גלישה והשארת פרטים מהווה הסכמה למדיניות הפרטיות שלנו.
            </p>
          </div>
          <div className="flex gap-4 text-sm font-bold text-neutral-300">
            <a href="#booking" className="hover:text-white hover:underline transition-all">מדיניות פרטיות</a>
            <span className="text-neutral-500">|</span>
            <a href="#booking" className="hover:text-white hover:underline transition-all">תנאי שימוש</a>
          </div>
        </div>
      </div>
    </section>
