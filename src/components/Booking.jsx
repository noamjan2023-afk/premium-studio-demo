      ...
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="flex flex-col items-center justify-center w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
            ...
            {/* WhatsApp */}
            <a href="https://wa.me/972526410042?text=היי אלכס, הגעתי דרך האתר ואשמח לעזרה" target="_blank" rel="noopener noreferrer" className="group flex flex-col items-center text-center gap-4 transition-all duration-300 hover:text-[#25D366] bg-white/5 border border-white/10 p-8 rounded-3xl hover:bg-white/10 hover:border-[#25D366]/30 shadow-xl">
